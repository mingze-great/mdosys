package com.mdosys.common.core.utils.uuid;
...
public class CodeUtils {
    ...
    private CodeUtils() throws CodeGenerateException {
        try {
    ...
    private static CodeUtils instance = null;

    public static synchronized CodeUtils getInstance() throws CodeGenerateException {
        if (instance == null) {
