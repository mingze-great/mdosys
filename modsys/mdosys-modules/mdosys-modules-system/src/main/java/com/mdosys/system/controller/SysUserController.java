...
import com.mdosys.common.core.constant.UserConstants;
...
import com.mdosys.system.service.ISysUserService;
...
//    @Log(title = "用户管理", businessType = BusinessType.IMPORT)
    ...
    public R<LoginUser> info(@PathVariable("username") String username)
    {
        ...
        // 权限集合
        Set<String> permissions = permissionService.getPermission(sysUser.getUserId());
...
//    }
    ...
    public AjaxResult getInfo()
    {
        ...
        // 权限集合
        Set<String> permissions = permissionService.getPermission(userId);
