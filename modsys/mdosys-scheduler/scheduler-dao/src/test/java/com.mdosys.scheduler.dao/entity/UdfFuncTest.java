...
import com.mdosys.scheduler.dao.entity.UdfFunc.UdfFuncDeserializer;
...
public class UdfFuncTest {
  ...
  public void testUdfFuncToString() {
    ...
    udfFunc.setResourceName("resource_update");
    udfFunc.setResourceId(2);
    udfFunc.setClassName("com.mdosys.scheduler.test.mrUpdate");

    Assert.assertEquals(
        "{\"id\":0,\"userId\":0,\"funcName\":null,\"className\":\"com.mdosys.scheduler.test.mrUpdate\",\"argTypes\":null,\"database\":null,"
            + "\"description\":null,\"resourceId\":2,\"resourceName\":\"resource_update\",\"type\":null,\"createTime\":null,\"updateTime\":null}",
        udfFunc.toString());
  }
