...
import com.mdosys.scheduler.dao.entity.UDFUser;
...
public class UdfFuncMapperTest {
    ...
    private UdfFunc insertOne() {
        ...
        udfFunc.setUserId(1);
        udfFunc.setFuncName("udf_func");
        udfFunc.setClassName("com.mdosys.scheduler.test.mr");
        udfFunc.setType(UdfType.HIVE);
        udfFunc.setResourceId(1);
        udfFunc.setResourceName("resource");
