...
UPDATE QRTZ_JOB_DETAILS SET JOB_CLASS_NAME='com.mdosys.scheduler.service.quartz.ProcessScheduleJob' WHERE JOB_CLASS_NAME='com.mdosys.scheduler.server.quartz.ProcessScheduleJob';
