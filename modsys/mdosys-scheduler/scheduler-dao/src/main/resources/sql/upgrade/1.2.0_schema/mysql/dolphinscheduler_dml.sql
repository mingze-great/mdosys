...
UPDATE QRTZ_JOB_DETAILS SET JOB_CLASS_NAME='com.mdosys.scheduler.dao.quartz.ProcessScheduleJob' WHERE JOB_CLASS_NAME='cn.escheduler.server.quartz.ProcessScheduleJob';
