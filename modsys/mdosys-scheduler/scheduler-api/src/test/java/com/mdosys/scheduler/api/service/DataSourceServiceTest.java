...
import com.mdosys.scheduler.api.service.impl.DataSourceServiceImpl;
...
import com.mdosys.scheduler.dao.entity.DataSource;
import com.mdosys.scheduler.dao.entity.User;
import com.mdosys.scheduler.dao.mapper.DataSourceMapper;
import com.mdosys.scheduler.dao.mapper.DataSourceUserMapper;
import com.mdosys.scheduler.plugin.datasource.api.datasource.BaseDataSourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.datasource.hive.HiveDataSourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.datasource.mysql.MysqlDatasourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.datasource.oracle.OracleDatasourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.datasource.postgresql.PostgreSqlDatasourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.plugin.DataSourceClientProvider;
import com.mdosys.scheduler.plugin.datasource.api.utils.CommonUtils;
import com.mdosys.scheduler.plugin.datasource.api.utils.DatasourceUtil;
import com.mdosys.scheduler.plugin.datasource.api.utils.PasswordUtils;
import com.mdosys.scheduler.spi.datasource.ConnectionParam;
import com.mdosys.scheduler.spi.enums.DbConnectType;
...
public class DataSourceServiceTest {
    ...
    public void createDataSourceTest() {
        ...
        BaseDataSourceParamDTO postgreSqlDatasourceParam = new PostgreSqlDatasourceParamDTO();
        ...
        postgreSqlDatasourceParam.setDatabase("scheduler");
        ...
        Result connectionResult = new Result(Status.DATASOURCE_CONNECT_FAILED.getCode(),
    ...
    public void updateDataSourceTest() {
        ...
        Result resourceNotExits = dataSourceService.updateDataSource(dataSourceId, loginUser,
        ...
        Result userNoOperationPerm = dataSourceService.updateDataSource(dataSourceId, loginUser,
                postgreSqlDatasourceParam);
        ...
        Result dataSourceNameExist = dataSourceService.updateDataSource(dataSourceId, loginUser,
                postgreSqlDatasourceParam);
        ...
        PowerMockito.when(dataSourceMapper.selectById(dataSourceId)).thenReturn(dataSource);
        PowerMockito.when(dataSourceMapper.queryDataSourceByName(dataSourceName)).thenReturn(null);
        connectionResult = new Result(Status.DATASOURCE_CONNECT_FAILED.getCode(),
                Status.DATASOURCE_CONNECT_FAILED.getMsg());
        PowerMockito.when(dataSourceService.checkConnection(dataSourceType, connectionParam))
                .thenReturn(connectionResult);
