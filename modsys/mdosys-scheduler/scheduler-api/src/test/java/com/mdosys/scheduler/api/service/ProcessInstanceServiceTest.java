...
import com.mdosys.scheduler.api.service.impl.LoggerServiceImpl;
import com.mdosys.scheduler.api.service.impl.ProcessInstanceServiceImpl;
import com.mdosys.scheduler.api.service.impl.ProjectServiceImpl;
...
public class ProcessInstanceServiceTest {
    ...
    public void testParseLogForDependentResult() throws IOException {
        String logString = "[INFO] 2019-03-19 17:11:08.475 com.mdosys.scheduler.server.worker.log.TaskLogger:[172]"
            + " - [taskAppId=TASK_223_10739_452334] dependent item complete :|| 223-ALL-day-last1Day,SUCCESS\n"
            + "[INFO] 2019-03-19 17:11:08.476 com.mdosys.scheduler.server.worker.runner.TaskScheduleThread:[172]"
