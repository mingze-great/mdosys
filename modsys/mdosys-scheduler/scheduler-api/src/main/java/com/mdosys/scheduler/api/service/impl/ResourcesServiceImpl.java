...
import com.mdosys.scheduler.api.dto.resources.filter.ResourceFilter;
import com.mdosys.scheduler.api.dto.resources.visitor.ResourceTreeVisitor;
import com.mdosys.scheduler.api.dto.resources.visitor.Visitor;
import com.mdosys.scheduler.api.enums.Status;
import com.mdosys.scheduler.api.exceptions.ServiceException;
import com.mdosys.scheduler.api.service.ResourcesService;
import com.mdosys.scheduler.api.utils.PageInfo;
import com.mdosys.scheduler.api.utils.RegexUtils;
...
import com.mdosys.scheduler.dao.utils.ResourceProcessDefinitionUtils;
...
public class ResourcesServiceImpl extends BaseServiceImpl implements ResourcesService {
    ...
    private boolean upload(User loginUser, String fullName, MultipartFile file, ResourceType type) {
        ...
        try {
            ...
            com.mdosys.scheduler.api.utils.FileUtils.copyInputStreamToFile(file, localFilename);
    ...
    public org.springframework.core.io.Resource downloadResource(int resourceId) throws IOException {
        ...
        return com.mdosys.scheduler.api.utils.FileUtils.file2Resource(localFileName);
    }
