...
import static com.mdosys.scheduler.spi.task.TaskConstants.HADOOP_SECURITY_AUTHENTICATION;
import static com.mdosys.scheduler.spi.task.TaskConstants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE;
import static com.mdosys.scheduler.spi.task.TaskConstants.JAVA_SECURITY_KRB5_CONF;
import static com.mdosys.scheduler.spi.task.TaskConstants.JAVA_SECURITY_KRB5_CONF_PATH;
import static com.mdosys.scheduler.spi.task.TaskConstants.KERBEROS;
import static com.mdosys.scheduler.spi.task.TaskConstants.LOGIN_USER_KEY_TAB_PATH;
import static com.mdosys.scheduler.spi.task.TaskConstants.LOGIN_USER_KEY_TAB_USERNAME;
import static com.mdosys.scheduler.spi.task.TaskConstants.RESOURCE_STORAGE_TYPE;
...
public class CommonUtils {
    ...
    public static String getHdfsDataBasePath() {
        String resourceUploadPath = PropertyUtils.getString(TaskConstants.RESOURCE_UPLOAD_PATH, "/scheduler");
