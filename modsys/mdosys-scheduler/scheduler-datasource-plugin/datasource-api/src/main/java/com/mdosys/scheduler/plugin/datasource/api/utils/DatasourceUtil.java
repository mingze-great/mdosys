...
package com.mdosys.scheduler.plugin.datasource.api.utils;

import com.mdosys.scheduler.plugin.datasource.api.datasource.BaseDataSourceParamDTO;
import com.mdosys.scheduler.plugin.datasource.api.datasource.DatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.clickhouse.ClickHouseDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.db2.Db2DatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.hive.HiveDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.mysql.MysqlDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.oracle.OracleDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.postgresql.PostgreSqlDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.presto.PrestoDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.spark.SparkDatasourceProcessor;
import com.mdosys.scheduler.plugin.datasource.api.datasource.sqlserver.SqlServerDatasourceProcessor;
