...
public class WorkflowExecuteThreadTest {
    ...
    public void init() throws Exception {
        ...
        workflowExecuteThread = PowerMockito.spy(new WorkflowExecuteThread(processInstance, processService, null, null,
                config, taskTimeoutCheckList, taskRetryCheckList));
    ...
    public void testGetStartTaskInstanceList() {
        try {
            ...
            method.setAccessible(true);
            List<TaskInstance> taskInstances = (List<TaskInstance>) method.invoke(workflowExecuteThread,
                    JSONUtils.toJsonString(cmdParam));
