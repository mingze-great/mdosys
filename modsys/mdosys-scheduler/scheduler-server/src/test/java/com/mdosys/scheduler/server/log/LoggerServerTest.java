...
public class LoggerServerTest {
    ...
    public void testRollViewLog() throws IOException {
        ...
        org.apache.commons.io.FileUtils.writeStringToFile(new File("/tmp/demo.txt"), expectedTmpDemoString,
    ...
    public void testRemoveTaskLog() throws IOException {
        ...
        org.apache.commons.io.FileUtils.writeStringToFile(new File("/tmp/remove.txt"), expectedTmpRemoveString,
                Charset.defaultCharset());
