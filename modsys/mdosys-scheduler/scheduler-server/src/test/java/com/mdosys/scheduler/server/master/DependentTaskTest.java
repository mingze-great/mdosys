...
public class DependentTaskTest {
        ...
        public void testBasicSuccess() {
                testBasicInit();
                ProcessInstance dependentProcessInstance = getProcessInstanceForFindLastRunningProcess(200,
                ...
                Mockito.when(processService
                                ...
                                .thenReturn(Stream.of(
                                                getTaskInstanceForValidTaskList(2000, ExecutionStatus.SUCCESS,
                                                                DEPEND_TASK_CODE_A, dependentProcessInstance),
                                                getTaskInstanceForValidTaskList(2000, ExecutionStatus.FAILURE,
                                                                DEPEND_TASK_CODE_B, dependentProcessInstance))
                                                .collect(Collectors.toList()));
        ...
        public void testDependentRelation() {
                ...
                ProcessInstance processInstance200 = getProcessInstanceForFindLastRunningProcess(200,
                                ExecutionStatus.FAILURE);
                ProcessInstance processInstance300 = getProcessInstanceForFindLastRunningProcess(300,
                                ExecutionStatus.SUCCESS);
                ...
                Mockito.when(processService
                                ...
                                .thenReturn(Stream.of(
                                                getTaskInstanceForValidTaskList(2000, ExecutionStatus.FAILURE,
                                                                DEPEND_TASK_CODE_A, processInstance200))
                                                .collect(Collectors.toList()));
                Mockito.when(processService
                                .findValidTaskListByProcessId(300))
                                .thenReturn(Stream.of(
                                                getTaskInstanceForValidTaskList(3000, ExecutionStatus.SUCCESS,
                                                                DEPEND_TASK_CODE_B, processInstance300),
                                                getTaskInstanceForValidTaskList(3001, ExecutionStatus.SUCCESS,
                                                                DEPEND_TASK_CODE_C, processInstance300))
                                                .collect(Collectors.toList()));
        ...
        public void testDependentOnAllFailure() {
                ...
                // DependentTaskExecThread dependentTask = new
                // DependentTaskExecThread(taskInstance);
                // dependentTask.call();
        ...
        public void testWaitAndCancel() {
                ...
                Mockito.when(processService
                                ...
                                .thenAnswer(i -> {
                                        ...
                                        return Stream.of(
                                                        getTaskInstanceForValidTaskList(2000,
                                                                        ExecutionStatus.RUNNING_EXECUTION,
                                                                        DEPEND_TASK_CODE_A, dependentProcessInstance))
                                                        .collect(Collectors.toList());
                                })
                ...
                // taskExecThread.call();
                // Assert.assertEquals(ExecutionStatus.KILL,
                // taskExecThread.getTaskInstance().getState());
        }
