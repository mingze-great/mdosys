...
import com.mdosys.scheduler.remote.command.TaskKillResponseCommand;
...
import com.mdosys.scheduler.remote.utils.Pair;
...
public class TaskKillProcessor implements NettyRequestProcessor {
    ...
    private TaskKillResponseCommand buildKillTaskResponseCommand(TaskKillRequestCommand killCommand,
        ...
        taskKillResponseCommand
                .setStatus(result.getLeft() ? ExecutionStatus.SUCCESS.getCode() : ExecutionStatus.FAILURE.getCode());
     ...
     */
    private Pair<Boolean, List<String>> killYarnJob(String host, String logPath, String executePath,
            String tenantCode) {
