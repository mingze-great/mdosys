...
package com.mdosys.scheduler.server.builder;
...
import com.mdosys.scheduler.spi.task.request.ProcedureTaskExecutionContext;
import com.mdosys.scheduler.spi.task.request.SQLTaskExecutionContext;
import com.mdosys.scheduler.spi.task.request.SqoopTaskExecutionContext;

import static com.mdosys.scheduler.common.Constants.SEC_2_MINUTES_TIME_UNIT;
...
public class TaskExecutionContextBuilder {
     ...
     * @return TaskExecutionContextBuilder
     */
    public TaskExecutionContextBuilder buildProcedureTaskRelatedInfo(
