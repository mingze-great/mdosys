...
package com.mdosys.scheduler.plugin.task.shell;

import org.apache.commons.collections4.MapUtils;
import com.mdosys.scheduler.plugin.task.api.AbstractTaskExecutor;
import com.mdosys.scheduler.plugin.task.api.ShellCommandExecutor;
import com.mdosys.scheduler.plugin.task.api.TaskResponse;
import com.mdosys.scheduler.plugin.task.util.OSUtils;
...
import static com.mdosys.scheduler.spi.task.TaskConstants.RWXR_XR_X;
...
public class ShellTask extends AbstractTaskExecutor {
     ...
     * shell parameters
     */
    private com.mdosys.scheduler.plugin.task.shell.ShellParameters shellParameters;
    ...
    public void init() {
        ...
        shellParameters = JSONUtils.parseObject(taskExecutionContext.getTaskParams(), com.mdosys.scheduler.plugin.task.shell.ShellParameters.class);
