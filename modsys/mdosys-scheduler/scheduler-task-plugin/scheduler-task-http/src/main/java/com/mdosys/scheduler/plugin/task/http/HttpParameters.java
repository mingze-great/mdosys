...
public class HttpParameters extends AbstractParameters {
     ...
     *  http params
     */
    private List<com.mdosys.scheduler.plugin.task.http.HttpProperty> httpParams;
    ...
    public List<com.mdosys.scheduler.plugin.task.http.HttpProperty> getHttpParams() {
        return httpParams;
    }

    public void setHttpParams(List<com.mdosys.scheduler.plugin.task.http.HttpProperty> httpParams) {
