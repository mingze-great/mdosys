...
package com.mdosys.scheduler.plugin.task.procedure;
...
import com.mdosys.scheduler.spi.enums.TaskTimeoutStrategy;
...
import static com.mdosys.scheduler.spi.task.TaskConstants.EXIT_CODE_FAILURE;
import static com.mdosys.scheduler.spi.task.TaskConstants.EXIT_CODE_SUCCESS;
...
public class ProcedureTask extends AbstractTaskExecutor {
     ...
     */
    private com.mdosys.scheduler.plugin.task.procedure.ProcedureParameters procedureParameters;
    ...
    public ProcedureTask(TaskRequest taskExecutionContext) {
        ...
        this.procedureParameters = JSONUtils.parseObject(taskExecutionContext.getTaskParams(), com.mdosys.scheduler.plugin.task.procedure.ProcedureParameters.class);
