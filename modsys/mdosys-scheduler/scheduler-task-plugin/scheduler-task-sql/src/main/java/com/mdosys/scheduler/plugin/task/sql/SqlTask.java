...
import com.mdosys.scheduler.plugin.task.api.TaskException;
...
import com.mdosys.scheduler.spi.task.*;
...
import com.mdosys.scheduler.spi.task.request.SQLTaskExecutionContext;
import com.mdosys.scheduler.spi.task.request.TaskRequest;
import com.mdosys.scheduler.spi.task.request.UdfFuncRequest;
...
public class SqlTask extends AbstractTaskExecutor {
    ...
    private PreparedStatement prepareStatementAndBind(Connection connection, SqlBinds sqlBinds) {
        ...
        try {
            ...
            if (params != null) {
                for (Entry<Integer, Property> entry : params.entrySet()) {
    ...
    private static void buildJarSql(List<String> sqls, Map<UdfFuncRequest,String> udfFuncTenantCodeMap, String defaultFS) {
        ...
        for (Entry<UdfFuncRequest, String> entry : entries) {
