...
public class PigeonTask extends AbstractTaskExecutor {
    ...
    private com.mdosys.scheduler.plugin.task.pigeon.PigeonParameters parameters;
    private BizResult triggerResult;
    private final com.mdosys.scheduler.plugin.task.pigeon.PigeonConfig config;

    public PigeonTask(TaskRequest taskExecutionContext) {
        super(taskExecutionContext);
        this.taskExecutionContext = taskExecutionContext;
        this.config = com.mdosys.scheduler.plugin.task.pigeon.PigeonConfig.getInstance();
    }
    ...
    public void init() {
        ...
        parameters = JSONUtils.parseObject(taskExecutionContext.getTaskParams(), com.mdosys.scheduler.plugin.task.pigeon.PigeonParameters.class);
