...
public class NetUtils {
    ...
    private static boolean isSpecifyNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = PropertyUtils.getString(Constants.SCHEDULER_NETWORK_INTERFACE_PREFERRED,
                System.getProperty(Constants.SCHEDULER_NETWORK_INTERFACE_PREFERRED));
    ...
    private static NetworkInterface findAddress(List<NetworkInterface> validNetworkInterfaces) {
        ...
        String networkPriority = PropertyUtils.getString(Constants.SCHEDULER_NETWORK_PRIORITY_STRATEGY,
