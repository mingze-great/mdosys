...
import com.mdosys.scheduler.common.enums.ResUploadType;
import com.mdosys.scheduler.common.exception.BaseException;
...
import static com.mdosys.scheduler.common.Constants.RESOURCE_UPLOAD_PATH;
...
public class HadoopUtils implements Closeable {
    ...
    public static final String resourceUploadPath = PropertyUtils.getString(RESOURCE_UPLOAD_PATH, "/scheduler");
    ...
    /**
     * init scheduler root path in hdfs
     */
        ...
        try {
            ...
            if (resUploadType == ResUploadType.HDFS) {
                ...
                if (defaultFS.startsWith("file")) {
                    ...
                    logger.info("get property:{} -> {}, from core-site.xml hdfs-site.xml ", Constants.FS_DEFAULTFS,
                            defaultFS);
                }
    ...
    public String getApplicationUrl(String applicationId) throws Exception {
        ...
        String activeResourceManagerPort = String
                .valueOf(PropertyUtils.getInt(Constants.HADOOP_RESOURCE_MANAGER_HTTPADDRESS_PORT, 8088));
    ...
    public ExecutionStatus getApplicationStatus(String applicationId) throws Exception {
        ...
        String responseContent = PropertyUtils.getBoolean(Constants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE, false)
        ...
        if (responseContent != null) {
            ...
            responseContent = PropertyUtils.getBoolean(Constants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE, false)
    ...
    private static final class YarnHAAdminUtils extends RMAdminCLI {
        ...
        public static String getAcitveRMName(String rmIds) {
            ...
            int activeResourceManagerPort = PropertyUtils.getInt(Constants.HADOOP_RESOURCE_MANAGER_HTTPADDRESS_PORT,
                    8088);
        ...
        public static String getRMState(String url) {
            ...
            String retStr = PropertyUtils.getBoolean(Constants.HADOOP_SECURITY_AUTHENTICATION_STARTUP_STATE, false)
