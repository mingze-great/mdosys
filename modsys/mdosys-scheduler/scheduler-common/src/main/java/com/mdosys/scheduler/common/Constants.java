...
public final class Constants {
        ...
        public static final String QUARTZ_INSTANCENAME = "SCHEDULER";
         ...
         * registry properties
         */
        public static final String REGISTRY_SCHEDULER_MASTERS = "/nodes/master";
        public static final String REGISTRY_SCHEDULER_WORKERS = "/nodes/worker";
        public static final String REGISTRY_SCHEDULER_DEAD_SERVERS = "/dead-servers";
        public static final String REGISTRY_SCHEDULER_NODE = "/nodes";
        public static final String REGISTRY_SCHEDULER_LOCK_MASTERS = "/lock/masters";
        public static final String REGISTRY_SCHEDULER_LOCK_FAILOVER_MASTERS = "/lock/failover/masters";
        public static final String REGISTRY_SCHEDULER_LOCK_FAILOVER_WORKERS = "/lock/failover/workers";
        public static final String REGISTRY_SCHEDULER_LOCK_FAILOVER_STARTUP_MASTERS = "/lock/failover/startup-masters";
         ...
         * scheduler.env.path
         */
        public static final String SCHEDULER_ENV_PATH = "scheduler.env.path";

        /**
         * environment properties default path
         */
        public static final String ENV_PATH = "env/scheduler_env.sh";
         ...
         */
        public static final String SCHEDULER_NETWORK_INTERFACE_PREFERRED = "scheduler.network.interface.preferred";

        /**
         * network IP gets priority, default inner outer
         */
        public static final String SCHEDULER_NETWORK_PRIORITY_STRATEGY = "scheduler.network.priority.strategy";
