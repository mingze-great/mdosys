...
import com.mdosys.scheduler.remote.codec.NettyDecoder;
import com.mdosys.scheduler.remote.codec.NettyEncoder;
...
import com.mdosys.scheduler.remote.exceptions.RemotingException;
import com.mdosys.scheduler.remote.exceptions.RemotingTimeoutException;
import com.mdosys.scheduler.remote.exceptions.RemotingTooMuchRequestException;
import com.mdosys.scheduler.remote.future.InvokeCallback;
import com.mdosys.scheduler.remote.future.ReleaseSemaphore;
import com.mdosys.scheduler.remote.future.ResponseFuture;
import com.mdosys.scheduler.remote.handler.NettyClientHandler;
import com.mdosys.scheduler.remote.processor.NettyRequestProcessor;
import com.mdosys.scheduler.remote.utils.*;
...
public class NettyRemotingClient {
    ...
    public NettyRemotingClient(final NettyClientConfig clientConfig) {
        ...
        this.responseFutureExecutor = Executors
                .newSingleThreadScheduledExecutor(new NamedThreadFactory("ResponseFutureExecutor"));
     ...
     * @return command
     */
    public Command sendSync(final Host host, final Command command, final long timeoutMillis)
