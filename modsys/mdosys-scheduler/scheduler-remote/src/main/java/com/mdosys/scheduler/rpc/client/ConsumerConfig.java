...
import com.mdosys.scheduler.rpc.common.ConsumerConfigConstants;

/**
 * We will cache the consumer configuration, when the rpc call is generated, the
 * consumer configuration will be first obtained from here
 */
