...
import com.mdosys.scheduler.service.quartz.cron.CronUtilsTest;
...
public class ProcessServiceTest {
    ...
    public void testGenDagGraph() {
        ...
        Mockito.when(processTaskRelationMapper.queryByProcessCode(Mockito.anyLong(), Mockito.anyLong()))
                .thenReturn(list);

        DAG<String, TaskNode, TaskNodeRelation> stringTaskNodeTaskNodeRelationDAG = processService
    ...
    public void testUpdateTaskDefinitionResources() throws Exception {
        ...
        String taskParameters = "{\n"
                + "    \"mainClass\": \"com.mdosys.scheduler.SparkTest\",\n"
                + "    \"mainJar\": {\n"
                + "        \"id\": 1\n"
                + "    },\n"
                + "    \"deployMode\": \"cluster\",\n"
        ...
        Map<Integer, Resource> resourceMap = Stream.of(1, 3, 4)
                .map(i -> {
