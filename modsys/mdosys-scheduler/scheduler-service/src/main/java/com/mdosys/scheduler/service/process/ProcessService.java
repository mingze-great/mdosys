...
package com.mdosys.scheduler.service.process;
...
import com.mdosys.scheduler.common.utils.CodeGenerateUtils.CodeGenerateException;
...
import com.mdosys.scheduler.service.exceptions.ServiceException;
...
public class ProcessService {
    ...
    public ProcessInstance handleCommand(Logger logger, String host, Command command,
            HashMap<String, ProcessDefinition> processDefinitionCacheMaps) {
    ...
    private Date getScheduleTime(Command command, Map<String, String> cmdParam) {
        ...
        if (scheduleTime == null
            ...
            List<Schedule> schedules = queryReleaseSchedulerListByProcessDefinitionCode(
    ...
    private void setGlobalParamIfCommanded(ProcessDefinition processDefinition, Map<String, String> cmdParam) {
        ...
        if (startParamMap.size() > 0
            ...
            for (Entry<String, String> param : processDefinition.getGlobalParamMap().entrySet()) {
    ...
    private ProcessInstance constructProcessInstance(Command command, String host,
        ...
        if (processInstance.getCommandParam() != null) {
            ...
            for (Entry<String, String> entry : processCmdParam.entrySet()) {
        ...
        switch (commandType) {
            ...
            case START_FAILURE_TASK_PROCESS:
                ...
                List<Integer> failedList = this.findTaskIdByInstanceState(processInstance.getId(),
                        ExecutionStatus.FAILURE);
                List<Integer> toleranceList = this.findTaskIdByInstanceState(processInstance.getId(),
                        ExecutionStatus.NEED_FAULT_TOLERANCE);
                List<Integer> killedList = this.findTaskIdByInstanceState(processInstance.getId(),
            ...
            case RECOVER_SUSPENDED_PROCESS:
                ...
                cmdParam.remove(Constants.CMD_PARAM_RECOVERY_START_NODE_STRING);
                List<Integer> suspendedNodeList = this.findTaskIdByInstanceState(processInstance.getId(),
    ...
    public TaskInstance submitTask(TaskInstance taskInstance) {
        ...
        logger.info("end submit task to db successfully:{} {} state:{} complete, instance id:{} state: {}  ",
                taskInstance.getId(), taskInstance.getName(), task.getState(), processInstance.getId(),
    ...
    public boolean updateTaskInstance(TaskInstance taskInstance) {
        ...
        logger.debug("updateTaskInstance, task instance id:{}, state;{}", taskInstance.getId(),
        ...
        if (Objects.nonNull(needChecks) && needChecks.length > 0) {
            ...
            switch (authorizationType) {
                ...
                case UDF_FILE:
                    ...
                    Set<Integer> authorizedResourceFiles = ownUdfResources.stream().map(Resource::getId)
                            .collect(toSet());
    ...
    public String getResourceIds(TaskDefinition taskDefinition) {
        ...
        AbstractParameters params = TaskParametersUtils.getParameters(taskDefinition.getTaskType(),
                taskDefinition.getTaskParams());
    ...
    public int saveTaskRelation(User operator, long projectCode, long processDefinitionCode,
        ...
        List<ProcessTaskRelation> processTaskRelationList = processTaskRelationMapper.queryByProcessCode(projectCode,
                processDefinitionCode);
        if (!processTaskRelationList.isEmpty()) {
            Set<Integer> processTaskRelationSet = processTaskRelationList.stream().map(ProcessTaskRelation::hashCode)
                    .collect(toSet());
    ...
    public DagData genDagData(ProcessDefinition processDefinition) {
        ...
        List<TaskDefinition> taskDefinitions = taskDefinitionLogList.stream()
                .map(taskDefinitionLog -> JSONUtils.parseObject(JSONUtils.toJsonString(taskDefinitionLog),
